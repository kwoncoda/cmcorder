...
const BoothMinimapModal = forwardRef(function BoothMinimapModal(
  ...
  // backdrop 클릭 — 자식 클릭은 버블되어도 target !== currentTarget 이므로 무시.
  ...
  return (
    ...
    >
      {/* 상단 X 버튼 (보조 닫기 — UX 관습) */}
      <header className="flex items-center justify-between p-md bg-bg/90">
        <h2
          id="minimap-title"
      ...
      <div className="flex-1 flex items-center justify-center p-md overflow-auto">
        {mapImage ? (
      ...
      <footer className="p-md bg-bg/90 border-t border-divider">
        <Button
          ref={closeBtnRef}
          variant="primary"
          size="lg"
